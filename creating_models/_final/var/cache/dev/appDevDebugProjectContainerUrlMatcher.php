...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/clients')) {
            ...
            // modify_client
            if (0 === strpos($pathinfo, '/clients/modify') && preg_match('#^/clients/modify/(?P<client_id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        if (0 === strpos($pathinfo, '/reservation')) {
            ...
            // booking
            if (preg_match('#^/reservation/(?P<client_id>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // book_room
        if (0 === strpos($pathinfo, '/book_room') && preg_match('#^/book_room/(?P<client_id>[^/]++)/(?P<room_id>[^/]++)/(?P<date_in>[^/]++)/(?P<date_out>[^/]++)$#s', $pathinfo, $matches)) {
        ...
        // cancel_booking
        if (0 === strpos($pathinfo, '/reservation/cancel') && preg_match('#^/reservation/cancel/(?P<reservation_id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'cancel_booking')), array (  '_controller' => 'AppBundle\\Controller\\ReservationsController::cancel',));
        }
